...
`python3 ../dashboard.py all-nondraft-PRs.json all-draft-PRs.json one-day-stale.json queue.json new-contributor.json needs-merge.json maintainer-merge.json delegated.json > ../expected.html`,
