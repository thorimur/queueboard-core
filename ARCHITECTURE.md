...
`python3 ../dashboard.py all-nondraft-PRs.json all-draft-PRs.json queue.json ready-to-merge.json new-contributor.json needs-merge.json maintainer-merge.json delegated.json automerge.json > ../expected.html`,
