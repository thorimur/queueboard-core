...
def main() -> None:
    ...
    # As a final feature, we propose a reviewer for 40 (randomly drawn) stale unassigned pull requests,
    # and write this information to "automatic_assignments.json".
    # NB. These 40 PRs include any PRs without any suggested reviewer (say, because an area has not enough
    ...
    proposed_reviews = suggest_reviewers_many(assignment_stats.assignments, reviewer_info, sorted(to_analyze[0:40]), aggregate_info)
